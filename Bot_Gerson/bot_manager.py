...
class BotManager(ctk.CTk):
    ...
    def export_log(self):
        ...
        try:
            ...
            script_dir = os.path.dirname(os.path.abspath(__file__))
            log_file = os.path.join(script_dir, "logs", "bot_logs.log")
            ...
            suggested_name = f"gerson_bot_log_{timestamp}.log"
            ...
            dest_path = filedialog.asksaveasfilename(
                ...
                title="Exportar Log do Gerson Bot"
            )
